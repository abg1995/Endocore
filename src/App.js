  ...
  const products = [
    {
        ...
        description: `The Drape Support is crafted entirely from radiolucent, high-performance engineering plastics for superior rigidity, durability and resistance to chemical attack. 
        The Drape Support is lightweight and compact taking up minimal space around the imaging table and even less when folded for storage. With two articulating joints, it can be easily manoeuvred to suit procedural and patient requirements.
    ...
    },
    {
        ...
        description: `The Retrograde IR Platform offers a stable, radiolucent, height and length appropriate work surface, providing clinical benefits to the current practice of laying procedural equipment on the mattress and patient. 
        It is the ultimate solution for catheter/guide wire manipulation, presenting a large surface area conveniently aligned with the femoral artery site for supporting equipment during a procedure.` ,
    },
    {
        id:4,
        ...
        description: `The Antegrade IR Platform provides a convenient worksurface to facilitate procedural workflow and enhance the operational environment during antegrade femoral access procedures.
         It is the ultimate solution for catheter/guide wire manipulation, presenting a large surface area conveniently aligned with the femoral artery site for supporting equipment during a procedure.` ,
    },
    {
        id:5,
        ...
        description: `The Lower Leg Support has been developed to gently immobilise the patient’s leg during Fluoroscopy guided treatment of Critical Limb Ischemia. 
        Clinician led, the ergonomic design optimally positions the leg for procedural requirements desired during lower limb interventions.` ,
    ...
    },
    {
        ...
        description: `Designed to comfortably support the supine patient’s arms, it eliminates extreme shoulder flexion, allows abdominal access and removes unwanted artefacts when imaging. 
        This versatile device will support one or both arms in the supine position and a single arm when used with the posterior oblique position.
    ...
    },
    {
        ...
        description: `The ArmSure prevents a restless patient from compromising the sterile femoral access site while presenting the forearm for IV lines, anaesthesia, etc.,
         throughout the procedure. The ArmSure gently secures both arms of a supine patient in a comfortable adducted position with soft, easy to install, adjustable straps.
        The unique design allows the straps to be loose while maintaining arm security and patient comfort.` ,
    ...
    },
    {
        ...
        The arm supporting surface is cantilevered out from the imaging table, accommodating a variety of patient sizes and mobility ranges comfortably. 
        The arms can be positioned according to individual patient shoulder mobility or procedural needs.` ,
